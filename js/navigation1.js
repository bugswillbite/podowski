document.addEventListener('DOMContentLoaded', function() {
                                ...
                                <div class="folder-content" id="video-editing-all-folder">
                                    <div class="folder-inner">
                                        <div class="image-gallery subsection-gallery">
                                            ...
                                            <div class="image-row">
                                                <div class="medium-item">
                                                    <a href="https://www.youtube.com/watch?v=vmYfJ6PbNyc&list=RDvmYfJ6PbNyc&start_radio=1" target="_blank">
                                                        <video src="vids/broadcast.mp4" autoplay muted loop webkit-playsinline playsinline>
                                                            <source src="vids/broadcast.mp4" type="video/mp4">
                                                        </video>
                                                        <div class="overlay-text">Broadcast - Lights Out</div>
                                                    </a>
                                                </div>
                                                <div class="medium-item">
                                                ...
                                                <div class="medium-item">
                                                    <a href="https://www.youtube.com/watch?v=T9eVlcHXMsw" target="_blank">
                                                        <video src="vids/c0.mp4" autoplay muted loop webkit-playsinline playsinline>
                                                            <source src="vids/c0.mp4" type="video/mp4">
                                                        </video>
                                                        <div class="overlay-text">Crash Override Game Teaser</div>
                                                    </a>
                                                </div>
                                            </div>
                                            <h3>Eatin' Asphalt F1 Podcast:</h3>
                                            <div class="image-row">
                                                <div class="medium-item">
                                                    <a href="https://www.youtube.com/watch?v=ysV1I1Gef88&t=1952s" target="_blank">
                                                        <video src="vids/ea1.mp4" autoplay muted loop webkit-playsinline playsinline>
                                                            <source src="vids/ea1.mp4" type="video/mp4">
                                                        </video>
                                                        <div class="overlay-text">Eatin' Asphalt Ep 120</div>
                                                    </a>
                                                </div>
                                                <div class="medium-item">
                                                    <a href="https://www.youtube.com/@EatinAsphalt/videos" target="_blank">
                                                        <video src="vids/ea2.mp4" autoplay muted loop webkit-playsinline playsinline>
                                                            <source src="vids/ea2.mp4" type="video/mp4">
                                                        </video>
                                                        <div class="overlay-text">Eatin' Asphalt Intro</div>
                                                    </a>
                                                </div>
                                                <div class="medium-item">
                                                    <a href="https://www.youtube.com/watch?v=Mff4XMopj_I" target="_blank">
                                                        <video src="vids/ea3.mp4" autoplay muted loop webkit-playsinline playsinline>
                                                            <source src="vids/ea3.mp4" type="video/mp4">
                                                        </video>
                                                        <div class="overlay-text">Eatin' Asphalt Ep 108</div>
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="folder-content" id="education-folder">
                                    <div class="folder-inner">
                                        ...
                                        <ul>
                                            ...
                                            <li>Video Production & Post-Production - Adobe Premiere Pro, After Effects, Videography</li>
    ...
    const initialSection = 'portfolio'; 
    switchContent(initialSection);

    document.querySelector('div.op1').classList.remove('active'); 
    document.querySelector('div.op4').classList.add('active');
});
